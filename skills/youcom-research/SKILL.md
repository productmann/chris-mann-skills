...
description: Research any topic using the You.com Research API for deep, multi-step web research with cited sources. Use this skill whenever the user asks to research, look up, investigate, or find current information on any topic — including casual phrasings like "can you look into X", "find out about Y", or "what's the latest on Z". Prefer this skill over relying on training data alone when the user wants recent, sourced, or comprehensive information.
allowed-tools: Bash
---
